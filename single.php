...
// j'affiche les données de la page choisie
...
foreach($resultat as $key => $variable)
{
	...
	echo "<form method='post' action='admin/insert-emprunt.php'>";
	echo "<input type='hidden' name='id_objet' value='$id_objet'>";
	echo "<br/>";
	echo "<label>Confirmer l'emprunt ? </label>";
	echo "<br/>";
	echo "(Cocher pour confirmer) <input type='checkbox' name='confirm_emprunt'>";
	echo "<br/>";
	echo "<br/>";
	echo "<button type='submit' >Emprunter</button>";
	echo "</form>";
	echo "<br/>";
	echo "<br/>";
