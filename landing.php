...
?>
	...
	<?php include 'inc/navbar.php' ?>
			...
			<?php
					...
					echo "</h5>";
						...
						// gestion de l'affichage de la quantité et de la disponibilité
							...
							if ($quantite > 0) {
								if ($quantite == 1) {$pluriel = '';}
								if ($quantite > 1) {$pluriel = 's';}
		...
		if (($requete_count_admin[0][0])>1){$pluriel="s";}else{$pluriel="";}
		echo "<li>".$requete_count_admin[0][0]." administrateur$pluriel</li>";
		echo "<br />";
		...
		if (($requete_count_emprunteurs[0][0])>1){$pluriel="s";}else{$pluriel="";}
		echo "<li>".$requete_count_emprunteurs[0][0]." emprunteur$pluriel inscrit$pluriel</li>";
		echo "<li><a href='admin/insert-user.php'>Ajouter un utilisateur</a></li>";
		echo "<li><a href='admin/delete-user.php'>Supprimer un utilisateur</a></li>";
		...
		if (($requete_count_category[0][0])>1){$pluriel="s";}else{$pluriel="";}
		echo "<li>".$requete_count_category[0][0]." catégorie$pluriel </li>";
		echo "<li><a href='#'>Ajouter une catégorie (non fonctionnel)</a></li>";
		echo "<li><a href='emprunts.php'>Supprimer une catégorie (non fonctionnel)</a></li>";
		
		echo "<br />";		
			/** Gestion Sous-catégorie **/
			echo "<h3>Gestion des sous-catégories</h3>";
		...
		if (($requete_count_subcategory[0][0])>1){$pluriel="s";}else{$pluriel="";}
		echo "<li>".$requete_count_subcategory[0][0]." sous-catégorie$pluriel </li>";
		echo "<li><a href='#'>Ajouter une sous-catégorie (non fonctionnel)</a></li>";
		echo "<li><a href='emprunts.php'>Supprimer une sous-catégorie (non fonctionnel)</a></li>";
		
		echo "<br />";			
			//afficher les sous-catégories
			/** Gestion Objets **/
			echo "<h3>Gestion des matériels</h3>";
		...
		if (($requete_count_objets[0][0])>1){$pluriel="s";}else{$pluriel="";}
		echo "<li>".$requete_count_objets[0][0]." objet$pluriel </li>";
		echo "<li><a href='admin/insert-objet.php'>Ajouter un objet (manque upload)</a></li>";
		echo "<li><a href='delete-objet.php'>Supprimer un objet</a></li>";	
		echo "<br />";		
		...
		if (($requete_count_emprunts_encours[0][0])>1){$pluriel="s";}else{$pluriel="";}
		echo "<li>".$requete_count_emprunts_encours[0][0]." emprunt$pluriel en cours </li>";
		...
		if (($requete_count_emprunts_clos[0][0])>1){$pluriel="s";}else{$pluriel="";}
		echo "<li>".$requete_count_emprunts_clos[0][0]." emprunt$pluriel clos (en historique) </li>";
		echo "<li><a href='emprunts.php'>Annuler un emprunt</a></li>";	
